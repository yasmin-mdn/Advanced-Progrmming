...
namespace A5Tests
{
    ...
    { 
        ...
        [TestMethod]
        public void TestFinallyBlockNoExceptionWithReturn()//pass
        {
            ExceptionHandler eh = new ExceptionHandler(
                "1", false, false);
        ...
        [TestMethod]
        public void TestFinallyBlockException()//pass
        {
            ExceptionHandler eh = new ExceptionHandler(
                "1", false, true);
        ...
        [TestMethod]
        public void NestedExceptionTest()//pass
        {
            ExceptionHandler eh = new ExceptionHandler(
                "1", false, true);
    ...
    [TestClass]
    public class GenerateExceptionTests//pass
    {
        [ExpectedException(typeof(InvalidDataException))]
        [TestMethod]
        public void ThrowNewExceptionTest()//pass
        {
            ExceptionHandler.ThrowIfOdd(5);
        }

        [TestMethod]
        public void DoNotThrowNewExceptionTest()//pass
        {
